...
const projects = [
  ...
  },
  {
    ...
    photoslink: "https://github.com/jonnekoi/euro2024Front/blob/master/ui-photos/photos.md"
  },
  {
    ...
    photoslink: "https://github.com/jonnekoi/fmm-front/blob/master/ui-photos/photos.md"
  },
  {
    title: "Personal Trainer Platform (In progress)",
    description: "This is a platform that connects personal trainers and clients. The idea is to make it easier for personal trainers to manage their clients. The application will also use machine learning to suggest meals and workouts based on other client results. This platform will include dashboard for trainers and mobile app for clients.",
    technologies: "JavaScript, Node.js, React, React Native, MariaDB, Tailwind CSS",
    icon: "<svg xmlns=\"http://www.w3.org/2000/svg\" fill=\"none\" viewBox=\"0 0 24 24\" strokeWidth={1.5} stroke=\"currentColor\" className=\"size-6\">\n" +
        "  <path strokeLinecap=\"round\" strokeLinejoin=\"round\" d=\"M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m.94 3.198.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0 1 12 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 0 1 6 18.719m12 0a5.971 5.971 0 0 0-.941-3.197m0 0A5.995 5.995 0 0 0 12 12.75a5.995 5.995 0 0 0-5.058 2.772m0 0a3 3 0 0 0-4.681 2.72 8.986 8.986 0 0 0 3.74.477m.94-3.197a5.971 5.971 0 0 0-.94 3.197M15 6.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm6 3a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Zm-13.5 0a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Z\" />\n" +
        "</svg>\n",
    githublink: "https://github.com/jonnekoi/gfit-web",
    servergithublink: "https://github.com/jonnekoi/GFit-Server",
    photoslink: "https://github.com/jonnekoi/gfit-web/blob/main/ui-photos/photos.md"
  },
  {
...
const Projects = () => {
  return (
      <section className="text-center m-14 w-3/5 project-mobile">
        <h3 className="text-white font-bold text-3xl m-10 poppins-font">Projects</h3>
